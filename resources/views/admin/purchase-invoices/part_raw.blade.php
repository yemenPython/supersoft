<tr id="tr_part_{{$index}}" class="remove_on_change_branch text-center-inputs tr_part_{{$index}}">
    ...
    <td>
        ...
        <span style="display:block; cursor: pointer" data-img="{{$part->image}}"
                ...
                <tr>
                    ...
                    <td>
                        @if(isset($item))
                            ...
                            <input  type="number" class="form-control border2" id="price_{{$index}}"
                                   value="{{$item->price}}"
                    ...
                    <td>
                        <input type="number" class="form-control border4" id="discount_{{$index}}"
                    ...
                    <td>
                        <input type="number" class="form-control border3" id="total_{{$index}}"

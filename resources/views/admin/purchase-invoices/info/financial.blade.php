                    ...
                    <ul class="list-inline flex-div-cen">
                        <li>
                            <div class="has-feedback">
                                <input type="checkbox" id="supplier_discount_check" name="supplier_discount_active" disabled
                        ...
                        <li>
                            ...
                            <input type="hidden" name="supplier_discount_type"  class="text-center supplier_discount_type_value"
        ...
        <table class="table table-bordered">
            <tr>
                <th style="width:40%;height:50px;background:#FFC5D7 !important;color:black !important;">
                    <div class="btn-group group-eye-wg-one" style="position: absolute;
    top: 22px;
    right: 81px;">
                        ...
                        <ul class="dropdown-menu for-design-eye" style="margin-top: 19px;">
                            @if($data['taxes']->count())
                                @foreach($data['taxes'] as $tax_key => $tax)
                                    ...
                                    <li>
                                        <a>
                                            <input type="checkbox" id="checkbox_tax_{{$tax_key}}" name="taxes[]" disabled

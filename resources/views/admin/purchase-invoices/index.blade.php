    ...
    <script type="application/javascript">
        ...
        function getLibraryFiles(id) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: '{{route('admin:purchase.invoices.library.get.files')}}',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                },
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        url: '{{route('admin:purchase.invoices.library.file.delete')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id,
                        },
        ...
        function uploadFiles() {
            ...
            $.ajax({
                url: "{{route('admin:purchase.invoices.upload_library')}}",
                type: "post",

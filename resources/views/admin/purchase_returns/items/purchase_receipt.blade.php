<tr id="tr_part_{{$index}}" class="remove_on_change_branch text-center-inputs tr_part_{{$index}}">
    ...
    <td>
        <span class="price-span"
              style="width: 120px !important;display:block">{{$item->supplyOrderItem &&  $item->supplyOrderItem->partPriceSegment ? $item->supplyOrderItem->partPriceSegment ->name : __('Not determined')}}</span>
    </td>

...
@section('title')
    <title>{{ __('Stop And Activate Asset') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Stop And Activate Asset')}}</li>
            </ol>
        </nav>
        @if(filterSetting())
            <div class="col-xs-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="status" id="status">
                                                ...
                                                <option value="stopped">{{__('stop,and still stopped')}}</option>
                                            </select>
                                        </div>
                                    </div>
        ...
        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card">
                <h4 class="box-title bg-secondary with-control">
                    <i class="fa fa-file-o"></i> {{__('Stop And Activate Asset')}}
                </h4>
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                        ...
                        <li class="list-inline-item">
                           ...
                           'route' => 'admin:stop_and_activate_assets.create',
                           'new' => __('activate asset'),
                          ],['custom_args'=>['status'=>'activate']])
                        </li>
                        <li class="list-inline-item">
                            @include('admin.buttons.add-new', [
                           'route' => 'admin:stop_and_activate_assets.create',
                           'new' => __('stop asset'),
                          ],['custom_args'=>['status'=>'stop']])
                        </li>
                    ...
                    <div class="table-responsive">
                        <table id="datatable-with-btns" class="table table-bordered wg-table-print table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                @endif
                                <th class="text-center column-asset" scope="col">{!! __('Asset name') !!}</th>

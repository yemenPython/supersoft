...
@section('title')
    <title>{{ __('Edit '.$status.' Asset') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{ __('Edit '.$status.' Asset') }}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            ...
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:stop_and_activate_assets.update',$stop_and_activate_assets)}}" class="form"
...
@section('js')
    <script type="application/javascript">
        ...
        function changeBranch() {
            ...
            window.location.href = "{{route('admin:stop_and_activate_assets.create')}}" + "?branch_id=" + branch_id;
        }

        ...
        <div class="row top-data-wg" style="box-shadow: 0 0 7px 1px #DDD;margin:5px 5px 10px;padding-top:20px">
            ...
            <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="number" class="form-control"
                                   placeholder="{{__('Concession number')}}" disabled
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group" id="concession_items"
                            ...
                            <select class="form-control js-example-basic-single" name="item_id" id="concession_item_id"
                                    onchange="getConcessionPartsData()">
                ...
                <input type="hidden" id="model" name="model"
                       value="{{isset($concession) ? class_basename($concession->concessionable_type) : ''}}">

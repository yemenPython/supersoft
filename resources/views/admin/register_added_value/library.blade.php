    ...
    @foreach ($files as $file)
        ...
        <div class="col-md-3" id="file_{{$file->id}}">
            ...
            <div style="border: 1px solid #e4e7ea; text-align: center; padding: 10px; margin-bottom: 10px">
                ...
                <a href="{{asset('storage/register_added_value_library/' . $library_path. '/' . $file->file_name)}}" target="_blank">
                    @if(in_array( $file->extension, ['gif','jpeg','jpg','png']))

                        <img style="width: 200px;height: 100px;"
                             src="{{asset('storage/register_added_value_library/' . $library_path. '/' . $file->file_name)}}">
                        <hr>

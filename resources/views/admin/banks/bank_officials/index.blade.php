...
@section('title')
    <title>{{ __('Bank Officials') }} </title>
@endsection

@include('admin.banks.bank_officials.modal')
    ...
    <div class="row small-spacing">
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{ __('Bank Officials') }}</li>
            </ol>
        </nav>

      @include('admin.banks.bank_officials.search_form')

        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card">
                <h4 class="box-title bg-secondary with-control">
                    <i class="fa fa-cubes"></i>  [{{count($items)}}] {{ __('Bank Officials')." : " .$bankData->name }}
                </h4>
    ...
    <script type="application/javascript">
        $(document).ready(function () {
            $('#add-employee-modal').on('show.bs.modal', function (event) {
                ...
                var old_bank_official_id = button.data('old_bank_official_id');
                $('#old_bank_official_id').val(old_bank_official_id);

        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item"><a
                        href="{{route('admin:banks.banks_accounts.index')}}"> {{__('Accounts')}}</a>
        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i
                        class="fa fa-user ico"></i>{{__('Edit')}}<span class="controls hidden-sm hidden-xs pull-left">
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:banks.banks_accounts.update',[$item->id] )}}"
                          class="form"

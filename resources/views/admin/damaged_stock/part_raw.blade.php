               ...
               <tr>
                   ...
                   <td>
                       <div class="input-group" id="stores">
                           ...
                           <select  class="form-control js-example-basic-single" name="items[{{$index}}][store_id]" id="store_part_{{$index}}"
                   ...
                   <td>
                       <input type="text" id="price_{{$index}}" class="form-control border2"

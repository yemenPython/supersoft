                    ...
                    <ul class="list-inline">
                        <li>
                            <div class="radio primary">
                                <input type="radio" name="type" value="natural" id="natural"
                                       onchange="showEmployeePercent()"
                        ...
                        <li>
                            <div class="radio primary">
                                <input type="radio" name="type" id="un_natural" value="un_natural"
                                       onchange="showEmployeePercent()"
    ...
    <table class="table table-bordered">
        ...
        <td style="background:#F9EFB7">
            <input type="text" disabled id="total_price"
                   ...
                   value="{{isset($damagedStock) ? $damagedStock->total : 0}}"
                   class="form-control">
        </td>
        </tbody>
    </table>
...
<div class="col-md-12" id="employees_percent"
    ...
    <div class="bottom-data-wg"
         style="display:inline-block;width:100%;box-shadow: 0 0 7px 1px #DDD;margin:5px auto 10px;padding:25px 15px 3px">

        <div class="col-md-12" style="color: white; margin-bottom: 60px; margin-right: -15px;">
            <div class="ribbon ribbon-r bg-secondary show-ribbon" style="background: rgb(86, 133, 204) !important;"><p
                    class="mb-0">{{__('Employees')}}</p></div>
        </div>

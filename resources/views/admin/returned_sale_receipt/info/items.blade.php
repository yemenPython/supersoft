<tr id="tr_part_{{$index}}" class="text-center-inputs remove_on_change_branch">
    ...
    <td>
        <input style="width: 130px !important;" type="number" class="form-control border2"
               id="refused_quantity_{{$index}}" disabled
    ...
    <td>
        <input style="width: 130px !important;" type="number" class="form-control border6"
               id="accepted_quantity_{{$index}}" disabled
    ...
    <td>
        <span id="barcode_{{$index}}">
            {{ $update_item->partPrice ? $update_item->partPrice->barcode : $part->default_barcode }}
        </span>
    </td>

    <td>
        <span id="supplier_barcode_{{$index}}">
             {{ $update_item->partPrice ? $update_item->partPrice->supplier_barcode : $part->default_supplier_barcode }}
        </span>
    </td>
</tr>

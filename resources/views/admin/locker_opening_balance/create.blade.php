        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item"><a
                        href="{{route('admin:lockers_opening_balance.index')}}"> {{__('Locker Opening Balance')}}</a></li>
                <li class="breadcrumb-item active"> {{__('Create Locker Opening Balance')}}</li>
            </ol>
        </nav>
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i
                        class="fa fa-money"></i>{{__('Create Locker Opening Balance')}}
                ...
                <div class="box-content">
                    ...
                    <form method="post" action="{{route('admin:lockers_opening_balance.store')}}" class="form">
                        @csrf
                        @method('post')

    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Locker Opening Balance')}}</li>
            </ol>
        </nav>

        @include('admin.locker_opening_balance.search_form')

        <div class="col-xs-12">
            <div class="box-content card bordered-all js__card">
                <h4 class="box-title bg-secondary with-control">
                    <i class="fa fa-money"></i> {{__('Locker Opening Balance')}}
                </h4>
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:lockers_opening_balance.create',
                           'new' => '',
                          ])
                        </li>
                        ...
                        <li class="list-inline-item">
                            ...
                            'route' => 'admin:lockers_opening_balance.deleteSelected',
                             ])
                            @endcomponent
                        </li>
...
@section('js')
    <script type="application/javascript">
        ...
        function getLibraryFiles(id) {
            ...
            $.ajax({
                type: 'post',
                url: '{{route('admin:lockers_opening_balance.library.get.files')}}',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                },
        ...
        function removeFile(id) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'post',
                        url: '{{route('admin:lockers_opening_balance.library.file.delete')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id,
                        },
        ...
        function uploadFiles() {
            ...
            $.ajax({
                url: "{{route('admin:lockers_opening_balance.upload_library')}}",
                type: "post",
                headers: {

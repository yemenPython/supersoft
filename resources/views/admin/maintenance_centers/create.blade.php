...
@section('title')
    <title>{{ __('Create Maintenance center') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin:suppliers.index')}}"> {{__('Maintenance centers')}}</a></li>
                <li class="breadcrumb-item active"> {{__('Create Maintenance center')}}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            <div class=" card box-content-wg-new bordered-all primary">
                <h4 class="box-title with-control" style="text-align: initial"><i
                        class="fa fa-user ico"></i>{{__('Create Maintenance centers')}}
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:maintenance_centers.store')}}" class="form"

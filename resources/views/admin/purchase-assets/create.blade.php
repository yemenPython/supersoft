...
@section('title')
    <title>{{ __('Create Purchase Asset') }} </title>
@endsection
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active">
                    <a href="{{route('admin:purchase-assets.index')}}"> {{__('Purchase Asset')}}</a></li>
                <li class="breadcrumb-item active"> {{__('Create Purchase Asset')}}</li>
            </ol>
        </nav>
        ...
        <div class="col-xs-12">
            ...
            <div class=" card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    <form method="post" action="{{route('admin:purchase-assets.store')}}" class="form"

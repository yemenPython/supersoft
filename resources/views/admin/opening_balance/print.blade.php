                        ...
                        <div class="col-xs-12">
                            <table class="table table-time-user">
                                <tr>
                                    ...
                                    <td style="font-weight: normal !important;">{{$openingBalance->operation_time}}
                                        - {{$openingBalance->operation_date}}</td>
                                </tr>
                                <tr>
...
@endif
        ...
        <div style="padding:0 20px;">
            <h5 class="invoice-to-title">{{__('Opening Balance items')}}</h5>

            ...
            <div class="card box-content-wg-new bordered-all primary">
                ...
                <div class="box-content">
                    ...
                    <form method="post">
                        ...
                        <div class="table-responsive center-data-wg"
                             style="box-shadow: 0 0 7px 1px #DDD;margin:10px 5px;padding:15px 15px 0">

                            <table
                                class="table table-responsive table-hover table-bordered remove-disabled text-center-inputs">
                                <thead>
                                <tr>
                                    <th width="5%">#</th>
                                ...
                                @foreach($openingBalance->items as $index=>$item)
                                    ...
                                    <tr>
                                        ...
                                        <td class="inline-flex-span">
                                            ...
                                            <span
                                                class="part-unit-span"> {{ $item->part->sparePartsUnit->unit }}  </span>
                                        </td>

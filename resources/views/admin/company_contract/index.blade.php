...
@section('title')
    <title>{{ __('Company Contract') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Company Contract')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-xs-12">
                <div class="box-content card bordered-all js__card top-search">
                    ...
                    <div class="card-content js__card_content">
                        <form id="filtration-form" action="{{route('admin:company_contract.index')}}" method="get">
            ...
            <div class="box-content card bordered-all js__card">
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:company_contract.create',
                           'new' => '',
                          ])
                        ...
                        <li class="list-inline-item">
                          ...
                          'route' => 'admin:company_contract.deleteSelected',
                           ])
                            @endcomponent
                        </li>
                                            ...
                                            <ul class="dropdown-menu dropdown-wg">
                                                <li>
                                                    <a class="btn btn-wg-show hvr-radial-out"
                                                       onclick="loadDataWithModal('{{route('admin:company_contract.show', $one->id)}}')" >
                                                ...
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._edit_button',[
                                                                'id' => $one->id,
                                                                'route'=>'admin:company_contract.edit'
                                                                 ])
                                                    @endcomponent
                                                </li>
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._delete_button',[
                                                                'id'=>$one->id,
                                                                'route' => 'admin:company_contract.destroy',
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{__('Company Contract Library')}}</h4>
                </div>
                <div class="modal-body">

                    <div class="row">
                        <form action="{{route('admin:company_contract.upload.upload_library')}}" method="post"
    ...
    <script type="application/javascript">
        ...
        function getLibrarySupplierId(id) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: '{{route('admin:company_contract.upload_library')}}',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                },
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        url: '{{route('admin:company_contract.upload_library.file.delete')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id,
                        },
        ...
        function uploadSupplierFiles() {
            ...
            var company_contract = $("#library_supplier_id").val();
            ...
            form_data.append("company_contract", company_contract);
            form_data.append("title_ar", title_ar);
            form_data.append("title_en", title_en);
            $.ajax({
                url: "{{route('admin:company_contract.upload.upload_library')}}",
                type: "post",

            ...
            <tr>
                ...
                <td style="background:#F9EFB7">
                    <input type="text" class="form-control" readonly name="sub_total" id="sub_total"
                           style="background:#F9EFB7; border:none;text-align:center !important;" value="{{isset($purchaseQuotation) ? $purchaseQuotation->sub_total : 0}}">
                </td>
            </tr>
        </table>
    </div>
        ...
        <table class="table table-bordered">
            <tr>
                <th style="width:40%;height:50px;background:#D2CCF8 !important;color:black !important">
                    ...
                    <span type="button" class="fa fa-eye eye-design-two dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        </span>

...
@section('title')
    <title>{{ __('Security Approval') }} </title>
@endsection
    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Security Approval')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-xs-12">
                <div class="box-content card bordered-all js__card top-search">
                    ...
                    <div class="card-content js__card_content">
                        <form id="filtration-form" action="{{route('admin:security_approval.index')}}" method="get">
            ...
            <div class="box-content card bordered-all js__card">
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:security_approval.create',
                           'new' => '',
                          ])
                        ...
                        <li class="list-inline-item">
                          ...
                          'route' => 'admin:security_approval.deleteSelected',
                           ])
                            @endcomponent
                        </li>
                                            ...
                                            <ul class="dropdown-menu dropdown-wg">
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._edit_button',[
                                                                'id' => $one->id,
                                                                'route'=>'admin:security_approval.edit'
                                                                 ])
                                                    @endcomponent
                                                </li>
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._delete_button',[
                                                                'id'=>$one->id,
                                                                'route' => 'admin:security_approval.destroy',
    ...
    <script type="application/javascript">
        ...
        function getLibrarySupplierId(id) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: '{{route('admin:security_approval.upload_library')}}',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                },
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        url: '{{route('admin:security_approval.upload_library.file.delete')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id,
                        },
        ...
        function uploadSupplierFiles() {
            ...
            var security_approval = $("#library_supplier_id").val();
            ...
            form_data.append("security_approval", security_approval);
            form_data.append("title_ar", title_ar);
            form_data.append("title_en", title_en);
            $.ajax({
                url: "{{route('admin:security_approval.upload.upload_library')}}",
                type: "post",

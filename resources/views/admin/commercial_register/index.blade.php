    ...
    <div class="row small-spacing">
        ...
        <nav>
            <ol class="breadcrumb" style="font-size: 37px; margin-bottom: 0px !important;padding:0px">
                ...
                <li class="breadcrumb-item active"> {{__('Commercial Register')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-xs-12">
                <div class="box-content card bordered-all js__card top-search">
                    ...
                    <div class="card-content js__card_content">
                        <form id="filtration-form" action="{{route('admin:commercial_register.index')}}" method="get">
            ...
            <div class="box-content card bordered-all js__card">
                ...
                <div class="card-content js__card_content" style="">
                    <ul class="list-inline pull-left top-margin-wg">
                       ...
                       'route' => 'admin:commercial_register.create',
                           'new' => '',
                          ])
                        ...
                        <li class="list-inline-item">
                          ...
                          'route' => 'admin:commercial_register.deleteSelected',
                           ])
                            @endcomponent
                        </li>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="currencies" class="table table-bordered" style="width:100%;margin-top:15px">
                            ...
                            <tr>
                                ...
                                <th class="text-center column-end_at" scope="col">{!! __('End On') !!}</th>
                                            ...
                                            <ul class="dropdown-menu dropdown-wg">
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._edit_button',[
                                                                'id' => $one->id,
                                                                'route'=>'admin:commercial_register.edit'
                                                                 ])
                                                    @endcomponent
                                                </li>
                                                <li class="btn-style-drop">
                                                    @component('admin.buttons._delete_button',[
                                                                'id'=>$one->id,
                                                                'route' => 'admin:commercial_register.destroy',
    ...
    <script type="application/javascript">
        ...
        function getLibrarySupplierId(id) {
            ...
            $.ajax({
                ...
                type: 'post',
                url: '{{route('admin:commercial_register.upload_library')}}',
                data: {
                    _token: CSRF_TOKEN,
                    id: id,
                },
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        url: '{{route('admin:commercial_register.upload_library.file.delete')}}',
                        data: {
                            _token: CSRF_TOKEN,
                            id: id,
                        },
        ...
        function uploadSupplierFiles() {
            ...
            var commercial_register = $("#library_supplier_id").val();
            ...
            form_data.append("commercial_register", commercial_register);
            form_data.append("title_ar", title_ar);
            form_data.append("title_en", title_en);
            $.ajax({
                url: "{{route('admin:commercial_register.upload.upload_library')}}",
                type: "post",

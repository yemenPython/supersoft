...
Route::get('assets_expenses_items/getAssetItemsExpenseById', 'AssetsItemExpenseController@getAssetItemsExpenseById')->name('assets_expenses_items.getAssetItemsExpenseById');
